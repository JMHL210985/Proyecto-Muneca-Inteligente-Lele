...
extern bool detecto;//esto es para detectar el rostro
...
int led_duty = 0;
bool isStreaming = true; //Cambie aqui
...
static int8_t detection_enabled = 1;//Cambie aqui
...
static void draw_face_boxes(fb_data_t *fb, std::list<dl::detect::result_t> *results, int face_id)
{
    ...
    for (std::list<dl::detect::result_t>::iterator prediction = results->begin(); prediction != results->end(); prediction++, i++)
    {
        ...
        detecto=true; // Se marca que detecto el rostro
#if TWO_STAGE
